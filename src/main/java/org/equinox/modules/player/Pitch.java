...
public class Pitch {
    ...
    public static KeyBinding pitchKey;
    ...
    public static void module(){
        ClientCommandRegistrationCallback.EVENT.register(((dispatcher, registryAccess) -> dispatcher.register(ClientCommandManager.literal("pitch")
                .executes(context -> {
                    ...
                    context.getSource().sendFeedback(Text.literal(EquinoxClient.CLIENT_PREFIX + "Pitch: " + isEnable));
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            if (pitchKey.wasPressed()) {
                ClientPlayerEntity player = client.player;
                isEnable = !isEnable;

                player.sendMessage(Text.literal(EquinoxClient.CLIENT_PREFIX + "Pitch: " + isEnable));
                ClientTickEvents.END_CLIENT_TICK.register(Pitch::onClientTick);
            }
        });
    }
